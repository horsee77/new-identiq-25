...
export default function Home() {
  const [careerAnim02, setCareerAnim02] = useState(null);
  const [careerAnim03, setCareerAnim03] = useState(null);

  useEffect(() => {
    let alive = true;

    fetch("/assets/lottie/face-id-pay.json")
      .then((r) => r.json())
      .then((data) => {
        if (alive) setCareerAnim02(data);
      })
      .catch((error) => {
        console.error("Erro ao carregar Lottie documents:", error);
      });

      fetch("/assets/lottie/Analytics.json")
      .then((r) => r.json())
      .then((data) => {
        if (alive) setCareerAnim03(data);
      })
      .catch((error) => {
        console.error("Erro ao carregar Lottie documents:", error);
      });
                  ...
                  <div className="single-wrapper">
                    <div className="check-wrapper">
                      <div className="single-check">
                        <Icon className="check-icon" icon="lucide:scan-face" width="20" height="20" />
                        <p>Captura do rosto no onboarding</p>
                      </div>
                      <div className="single-check">
                        <Icon className="check-icon" icon="lucide:user-check" width="20" height="20" />
          ...
          <div className="row g-5 mt--30">
            <div className="col-lg-4 wow fadeInUp" data-wow-delay=".1s">
              <div className="single-values-in-action">
                <div className="icon face-icon">
                  <Icon icon="lucide:scan-face" width="34" height="34" />
                </div>
            ...
            <div className="col-lg-4 wow fadeInUp" data-wow-delay=".3s">
              <div className="single-values-in-action">
                <div className="icon face-icon">
                  <Icon icon="lucide:shield-alert" width="34" height="34" />
                </div>
                <div className="information">
            ...
            <div className="col-lg-4 wow fadeInUp" data-wow-delay=".5s">
              <div className="single-values-in-action">
                <div className="icon face-icon">
                  <Icon icon="lucide:timer" width="34" height="34" />
                </div>
                <div className="information">
            ...
            <div className="col-lg-4 wow fadeInUp" data-wow-delay=".1s">
              <div className="single-values-in-action">
                <div className="icon face-icon">
                  <Icon icon="lucide:sliders-horizontal" width="34" height="34" />
                </div>
                <div className="information">
            ...
            <div className="col-lg-4 wow fadeInUp" data-wow-delay=".3s">
              <div className="single-values-in-action">
                <div className="icon face-icon">
                  <Icon icon="lucide:gauge" width="34" height="34" />
                </div>
                <div className="information">
            ...
            <div className="col-lg-4 wow fadeInUp" data-wow-delay=".5s">
              <div className="single-values-in-action">
                <div className="icon face-icon">
                  <Icon icon="lucide:webhook" width="34" height="34" />
                </div>
                <div className="information">

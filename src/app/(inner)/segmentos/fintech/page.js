    ...
    <div>
      ...
      <div>
        <div className="container-large">
          {/* service area start */}
          <div className="service-single-area-banner fintech bg_image jarallax"></div>
          {/* service area end */}
        </div>
      </div>
            ...
            <div className="row g-5">
              <div className="col-lg-6">
                <div className="thumbnail-area-large-service-detaile-mid jarallax jara-mask-1">
                  <Image
                    ...
                    src="/assets/images/fintech/fintech-01.png"
                    alt="service"
                    width={1200}
                    height={800}
                  />
              ...
              <div className="col-lg-6">
                <div className="thumbnail-area-large-service-detaile-mid jarallax jara-mask-1">
                  <Image
                    className="jarallax-img"
                    src="/assets/images/fintech/fintech-02.png"
                    alt="service"
                    width={1200}
                    height={800}
                  />

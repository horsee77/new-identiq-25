...
function BannerOne() {
  const [animLeft, setAnimLeft] = useState(null);
            ...
            <div className="col-lg-5">
              <div className="banner-wrapper-one">
                ...
                <p data-aos="fade-up" data-aos-delay="500">
                  Ajudamos empresas com verificação de identidade e prevenção a fraudes para se
                  manterem à frente na era digital
                </p>
